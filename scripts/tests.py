...
for mc_samples in [500, 5000]:
    ...
    print(f"should be closer to zero with more samples: with {mc_samples}",(observed_sample_counts/mc_samples - observation_pmf).abs().max())
